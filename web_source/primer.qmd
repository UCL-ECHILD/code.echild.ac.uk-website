...
While it is beyond the scope of the Repository to carry out this updating work, updated lists may be admitted to it. Compare, for example, the code list of stress-related emergency presentations developed by Blackburn et al [-@blackburn2021] with that of Ní Chobhthaigh et al [-@nichobhthaigh2024]. The latter is an update of the former, accounting for the latest research in mental health in paediatrics, including in diagnosing conditions.
