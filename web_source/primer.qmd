...
Each list will be accompanied by sample code that you are free to use, adapt or ignore as you wish. There are not yet available to download but current ECHILD users may contact [Matthew Jay](mailto:matthew.jay@ucl.ac.uk) for example code that is already available on the Secure Research Service.
