...
Not all code lists use ICD-10 or OPCS codes (or exclusively these). For example, the code list used to identify [emergency admissions](emergency_admissions_v1) makes use of `admimeth` values (see the @primer for more detail).
